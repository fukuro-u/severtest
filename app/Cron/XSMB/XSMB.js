...
module.exports = function() {
	...
	let customRequest = function(){request.get({url: 'https://wp.keg4re.site/wp-json/app-api/v1/lottery',},
		function(err, httpResponse, body){
			try {
					...
					for( const item of list){
						...
						xsmb.findOne({date:date}, {}, function(err, result) {
							if (!!result) {
								...
								xsmb.create({date:date, gdb:item.gdb, g1:item.g1, g2:item.g2, g3:item.g3, g4:item.g4, g5:item.g5, g6:item.g6, g7:item.g7});
								// date = null;
								// db = null;
								// g1 = null;
								// g2 = null;
